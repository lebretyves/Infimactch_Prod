...
prs.core_properties.title='InfiMatch — Soutenance';prs.core_properties.subject='Projet étudiant, instantané du 23 septembre 2026'
...
c.setTitle('InfiMatch — Soutenance');c.setAuthor('Équipe InfiMatch');c.setSubject('État documenté au 23 septembre 2026')
report=[]
...
for i,s in enumerate(DATA,1):
    ...
    text(slide,'Projet étudiant · État documentaire au 23 septembre 2026 · Réserves et sources : 05_ETUDE_DE_MARCHE.md',48,485,845,20,10,False,MUTED)
...
assert len( Presentation(ROOT/'InfiMatch_Soutenance_2026-09-23.pptx').slides)==12
print('PASS: 12 editable PPTX slides, 12 PDF pages; PDF text bounds checked; no external asset.')
