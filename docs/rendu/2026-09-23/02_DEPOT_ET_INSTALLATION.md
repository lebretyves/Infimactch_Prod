...
## Arborescence
backend/src : API et règles ; backend/test/unit et integration : tests ; frontend : site et administration ; workflows : modèles de recette ; docs/n8n/published-20260923 : exports publiés ; scripts : imports et exploitation ; docs/proofs : preuves datées.
