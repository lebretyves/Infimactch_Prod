...
- [Détail des hypothèses et du calcul](../rendu/2026-09-23/09_COUTS_PRODUCTION.md).
- [Déclaration des heures et limites du chiffrage réel](../rendu/2026-09-23/06_CHIFFRAGE_REEL.md).
- [Classeur de calcul des coûts](../rendu/2026-09-23/COUTS_PRODUCTION.xlsx).
- [Paramètres du modèle](../rendu/2026-09-23/couts-production.json), [calcul Python](../rendu/2026-09-23/calcul-couts.py) et [résultats](../rendu/2026-09-23/resultats-couts.json).
- [Soutenance : coût de réalisation page 11](../rendu/2026-09-23/InfiMatch_Soutenance_Pro_2026-09-23.pdf).
