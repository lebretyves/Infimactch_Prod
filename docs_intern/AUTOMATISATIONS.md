...
| Reprise et rappels | Toutes les 4 heures, Europe/Paris | Santé API, dispatch borné, rappels par lots | [reprise](../docs/n8n/InfiMatch-production-reprise-et-rappels.json) |
| Import France Travail | 07 h et 15 h, Europe/Paris dans l'export | Import borné, pagination et reprise contrôlée | [France Travail](../docs/n8n/InfiMatch-production-import-France-Travail.json) |
| Import JobsPipe | 07 h, Europe/Paris dans l'export | Import borné et reprise contrôlée | [JobsPipe](../docs/n8n/InfiMatch-production-import-JobsPipe.json) |
