...
- `infiMatch-front-end/docs/proofs/google-configuration.json` et `google-active.png`.
- Recette complète des raccordements : `docs/audits/v1-maquettes/BILAN_RACCORDEMENT_2026-09-16.md`.
