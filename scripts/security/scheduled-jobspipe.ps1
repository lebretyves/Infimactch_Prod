...
$logDirectory = Join-Path $projectRoot 'data/security/jobspipe'
...
Write-Log 'START import limit=10'
$resultCode = 1
try {
  $output = & 'C:\Program Files\nodejs\node.exe' scripts/vault/run.mjs cli import-jobspipe --limit 10 2>&1 | Out-String
