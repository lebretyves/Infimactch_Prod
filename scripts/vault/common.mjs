...
export const configKeys = ['SMTP2GO_FROM','NODE_ENV','PORT','APP_ORIGIN','TRUST_PROXY','DOCUMENT_KEY_VERSION','DOCUMENT_QUOTA_BYTES','MATCHING_RETENTION_DAYS','BUSINESS_HISTORY_RETENTION_DAYS','N8N_EDITOR_BASE_URL','N8N_EXTRA_CA_CERTS','MATCHING_WEIGHTS_JSON','N8N_WEBHOOK_BASE','REMINDER_DELAY_MINUTES','GOOGLE_CLIENT_ID','ADMIN_ORIGIN','PSC_ENABLED','PSC_ENVIRONMENT','RPPS_ENABLED'];
