...
export const configKeys = ['NODE_ENV','PORT','APP_ORIGIN','TRUST_PROXY','DOCUMENT_KEY_VERSION','DOCUMENT_QUOTA_BYTES','MATCHING_RETENTION_DAYS','MATCHING_WEIGHTS_JSON','N8N_WEBHOOK_BASE','REMINDER_DELAY_MINUTES','GOOGLE_CLIENT_ID'];
