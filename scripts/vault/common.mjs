...
export const backendKeys = ['DATABASE_URL','MONGODB_URI','SESSION_SECRET','DOCUMENT_KEY','SERVICE_TOKEN','RPPS_API_KEY','FT_CLIENT_ID','FT_CLIENT_SECRET','JOBSPIPE_API_KEY','GOOGLE_CLIENT_ID','DISCORD_RELAY_URL','DISCORD_RELAY_TOKEN','DISCORD_BOT_TOKEN','NOTIFICATION_APP_ORIGIN','PSC_CLIENT_ID','PSC_CLIENT_SECRET','SMTP2GO_API_KEY'];
