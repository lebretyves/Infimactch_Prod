...
export const backendKeys = ['DATABASE_URL','MONGODB_URI','SESSION_SECRET','DOCUMENT_KEY','SERVICE_TOKEN','RPPS_API_KEY','FT_CLIENT_ID','FT_CLIENT_SECRET'];
export const infraKeys = ['POSTGRES_PASSWORD','MONGO_PASSWORD','N8N_ENCRYPTION_KEY','SERVICE_TOKEN'];
export const configKeys = ['NODE_ENV','PORT','APP_ORIGIN','DOCUMENT_KEY_VERSION','MATCHING_RETENTION_DAYS','MATCHING_WEIGHTS_JSON','N8N_WEBHOOK_BASE','REMINDER_DELAY_MINUTES'];
