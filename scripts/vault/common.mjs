...
export const backendKeys = ['DATABASE_URL','MONGODB_URI','SESSION_SECRET','DOCUMENT_KEY','SERVICE_TOKEN','RPPS_API_KEY','FT_CLIENT_ID','FT_CLIENT_SECRET','JOBSPIPE_API_KEY','GOOGLE_CLIENT_ID','DISCORD_RELAY_URL','DISCORD_RELAY_TOKEN','DISCORD_BOT_TOKEN','NOTIFICATION_APP_ORIGIN','PSC_CLIENT_ID','PSC_CLIENT_SECRET'];
export const infraKeys = ['POSTGRES_PASSWORD','MONGO_PASSWORD','N8N_ENCRYPTION_KEY','SERVICE_TOKEN'];
export const configKeys = ['NODE_ENV','PORT','APP_ORIGIN','TRUST_PROXY','DOCUMENT_KEY_VERSION','DOCUMENT_QUOTA_BYTES','MATCHING_RETENTION_DAYS','BUSINESS_HISTORY_RETENTION_DAYS','N8N_EDITOR_BASE_URL','N8N_EXTRA_CA_CERTS','MATCHING_WEIGHTS_JSON','N8N_WEBHOOK_BASE','REMINDER_DELAY_MINUTES','GOOGLE_CLIENT_ID','ADMIN_ORIGIN','PSC_ENABLED','PSC_ENVIRONMENT','RPPS_ENABLED'];
