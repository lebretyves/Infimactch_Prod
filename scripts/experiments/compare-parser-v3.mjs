...
fs.mkdirSync('annexe/proofs/parser-pilot-v3',{recursive:true});fs.writeFileSync('annexe/proofs/parser-pilot-v3/results.json',JSON.stringify({summary,checks,offers:parsed},null,2));
...
fs.writeFileSync('annexe/proofs/parser-pilot-v3/COMPARAISON.md',lines.join('\n')+'\n');console.log(JSON.stringify(summary,null,2));
