...
const sample={assignmentId:'12345678-1234-4567-8901-123456789012',missionVersion:2,missionId:'87654321-4321-4321-8321-123456789012',establishmentContact:'Sophie Bernard — cadre de santé',population:'ADULT',block:'GENERAL',agencyName:'InfiMatch Santé — agence de démonstration',title:'IADE — Anesthésie au bloc opératoire',qualification:'IADE',service:'ANESTHESIE',address:'12 avenue de la Santé, 94800 Villejuif',start:'2026-10-12T06:00:00Z',end:'2026-10-12T14:00:00Z',timezone:'Europe/Paris',hourlySalary:'32.50',professionalName:'Camille Martin-Dupont',establishmentName:'Clinique des Tilleuls',issuedAt:new Date('2026-09-19T10:00:00Z'),demonstration:true};
(async()=>{
 for(const [name,data] of [
 ['confirmation-mission-exemple',sample],
 ['annulation-mission-exemple',{...sample,cancellation:{initiator:'NURSE',cancelledAt:'2026-09-19T12:00:00Z',reason:'Indisponibilité signalée par le professionnel. Le créneau est libéré ; l’établissement peut rechercher un remplaçant.'}}],
