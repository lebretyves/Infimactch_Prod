...
Le [bilan des 42 scénarios](../docs_intern/quality/MATRICE_42_TESTS_2026-09-19.md) indique ce qui est déployé, testé localement ou encore à valider. L’ancien inventaire d’écrans et les affirmations de simulation par défaut sont conservés dans [le README historique](../docs_intern/history/README_FRONTEND_AVANT_2026-09-19.md).
