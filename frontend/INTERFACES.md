...
Voir [le guide utilisateur](../docs_intern/GUIDE_UTILISATEUR.md), [les exigences](../docs_intern/REQUIREMENTS_V1.md), [le raccordement API](docs/INTEGRATION_BACKEND.md) et [le design](DESIGN.md). L'ancienne spécification détaillée a été archivée : elle ne décrit plus exhaustivement l'application livrée.
