...
> Note historique : depuis le 21 septembre 2026, ce formulaire séparé est retiré. Le parcours courant est décrit dans [Création et suivi des missions](../../docs_intern/ENTERPRISE_FOLLOW_UP.md). Les résultats ci-dessous concernent la version du 16 septembre.
