...
export function OfferOriginChoices({ value, onChange, partnersFirst = false, showExternes = true, showAll = true }: { value: OfferOrigin; onChange: (value: OfferOrigin) => void; partnersFirst?: boolean; showExternes?: boolean; showAll?: boolean }) {
  ...
  ).filter(([key]) => (showExternes || key !== 'externes') && (showAll || key !== 'toutes'));
