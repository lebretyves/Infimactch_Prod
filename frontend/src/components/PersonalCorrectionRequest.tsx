...
export function PersonalCorrectionRequest(){
 ...
 return <section style={{display:'grid',gridTemplateColumns:'minmax(0,1fr)',minWidth:0,gap:12,marginTop:16}} aria-labelledby={titleId}>
 <h3 id={titleId}>Correction de mes informations personnelles</h3>
 ...
 <TextField label="Nouvelle valeur demandée" type={field==='birthDate'?'date':'text'} autoComplete={field==='birthDate'?'bday':undefined} value={value} maxLength={500} disabled={busy} onChange={e=>setValue(e.target.value)}/>
