...
const labels: Record<string,string>={practiceServices:"Services souhaités pour ce métier",contract:"Contrat",qualification:"Qualification",service:"Expérience dans le service",experience:"Durée d’expérience",location:"Mobilité",shift:"Horaires",availability:"Disponibilités",assignmentConflicts:"Conflits de planning",requiredSkills:"Compétences requises",rpps:"Numéro RPPS",professionalEligibility:"Admissibilité professionnelle"};
