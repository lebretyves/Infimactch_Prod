...
export function NotificationSection({title, collapsible = false, defaultOpen = false, headingId, className, style, ariaLabel, children}: Props) {
  ...
  return <details className={s.panel} open={defaultOpen || undefined}>
