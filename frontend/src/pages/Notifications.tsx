...
export default function Notifications() {
  ...
  return <div className={`${s.page} ${s.focusedPage}`}>
    ...
    {!onboarding && <NotificationSection title="Votre activité" headingId="notice-list" className={s.card} collapsible={collapsible} defaultOpen>
