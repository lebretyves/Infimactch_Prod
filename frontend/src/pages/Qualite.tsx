...
export function Accessibilite() {
  return <QualityPage title="Accessibilité : état des travaux" description="Notre objectif est de rendre les parcours InfiMatch utilisables par le plus grand nombre.">
    <section><h2>Évaluation en cours</h2><p>État au 19 septembre 2026. Nous utilisons le RGAA 4.1.2 comme référence. Aucun audit complet n’a établi notre niveau de conformité : aucun pourcentage de conformité n’est annoncé.</p></section>
...
export function Ecoconception() {
  return <QualityPage title="Notre démarche d’écoconception" description="Réduire les ressources utilisées tout en conservant des parcours utiles et accessibles.">
    ...
    <section><h2>Mesurer sans surpromettre</h2><p>État au 19 septembre 2026. Le RGESN 2024, qui comporte 78 critères, sert de cadre. Le poids des fichiers produits par le build est suivi avant et après modification. Il ne mesure ni la consommation énergétique réelle ni les Core Web Vitals des utilisateurs.</p><p>Aucun score RGESN, label ou gain de CO₂ n’est revendiqué. Le cycle de vie du matériel, les engagements des hébergeurs et la gouvernance restent à documenter. Les imports sont regroupés à 7 h et 15 h pour France Travail, et à 7 h pour JobsPipe, heure de Paris. La reprise technique toutes les 30 minutes ne relance pas ces imports. Les anciennes notifications fictives sont neutralisées et les relances de missions non pourvues sont plafonnées. Ces choix réduisent les appels inutiles sans constituer une mesure de gain carbone.</p></section>
