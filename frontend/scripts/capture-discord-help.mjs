...
try {
  ...
  const id = '123456789012345678'; // Fictional fixture: never sent outside interception.
  ...
  await field.fill('123456789012345678');
  await page.locator('section[aria-labelledby=discord-settings]').screenshot({path:'public/aide/discord/05-formulaire-infimatch.png'});
