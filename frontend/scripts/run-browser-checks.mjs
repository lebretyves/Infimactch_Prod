...
try{
 for(const script of ['test-notification-read.mjs','test-mixed-recommendations.mjs','test-browser-errors.mjs','test-browser-accessibility.mjs','test-mission-publication.mjs','test-discord-defaults.mjs']){
