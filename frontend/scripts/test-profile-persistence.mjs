...
try{
 ...
 for(let i=1;i<=3;i++){
   profile.details.lastName='Test '+i;profile.skills=i===2?['TRIAGE','PERFUSION']:['TRIAGE'];profile.available=[{start:`2026-11-${String(10+i).padStart(2,'0')}T23:00:00Z`,end:`2026-11-${String(11+i).padStart(2,'0')}T23:00:00Z`}];profile.acceptedShifts=i===2?['NIGHT']:['DAY','NIGHT','MIXED'];
