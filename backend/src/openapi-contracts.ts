...
export const additionalResponses:Record<string,any>={
 ...
 "GET /api/v1/me/bank-details":obj({iban:nullable(str),details:nullable(obj({iban:str,bic:str,holder:str,bankName:str})),required:bool,document:nullable(obj({id:uuid,mime:str,size_bytes:int,created_at:date}))},["iban","details","required","document"]),
