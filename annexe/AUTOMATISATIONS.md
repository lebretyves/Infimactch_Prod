...
Les modèles dans `workflows/` servent aussi aux essais locaux ; ne pas les confondre avec les exports cloud dans `annexe/n8n/`. Une importation exige de réassocier les credentials privés puis de publier le workflow.
