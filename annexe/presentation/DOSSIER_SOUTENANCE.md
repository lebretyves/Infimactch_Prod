...
Les PDF/PPTX de ce dossier sont les versions historiques du 21 septembre. Pour l’oral de 15 minutes, utiliser le [dossier actualisé du rendu](../rendu/2026-09-23/README.md), le [complément notifications](../rendu/2026-09-24/InfiMatch_Dossier_Notifications.pdf) et le [dossier financier](../../documentation/business/2026-09-24/README.md). Les notes et sources ci-dessous restent consultables avec leur date ; elles ne certifient pas les nouveaux changements.
