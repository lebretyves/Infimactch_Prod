...
Le rapport HTML et le JSON sont generes dans `annexe/proofs/unit-coverage/` (ignores par Git). Ces resultats ont ete mesures sur `test/unit-coverage-95-20260923`, base sur `7cc590a`. Les preuves versionnees sont dans `annexe/proofs/unit-coverage-20260923/`. Ils ne constituent pas une validation d'un nouveau deploiement en production.
