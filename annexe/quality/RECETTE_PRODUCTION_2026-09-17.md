...
| Couverture | c8, `src/**/*.ts`, exclusions `main.ts` et `worker.ts` | Lignes/instructions 81,51 %, branches 80,12 %, fonctions 77,83 % ; rapport `annexe/proofs/v1-hardening/coverage.txt` |
