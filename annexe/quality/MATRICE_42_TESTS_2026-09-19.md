...
| TEST-15 | Import France Travail et comparaison JSON/base/interface | Partiel | external-collection.spec.ts; annexe/quality/IMPORTS_SOBRIETE_2026-09-19.md | Reprise/normalisation testées; nouvelle preuve fournisseur réel→base→interface à collecter. |
