...
114 anciens assets de galerie supprimés des fichiers publics, soit 16 890 801 octets. Leur historique reste dans Git. Le script historique de capture écrit désormais dans `frontend/annexe/proofs/catalogue-archives`, hors publication. L’ancien guide est explicitement marqué comme archive. Aucun lien vers les deux anciennes pages n’a été trouvé dans les composants de navigation actifs.
