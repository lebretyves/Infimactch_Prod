...
Preuve unitaire : 643 tests réussis, 95,07 % des lignes backend, sans contribution des tests d'intégration. Voir `annexe/proofs/unit-coverage-20260923/`. Une publication Git ne prouve pas que tous les projets Vercel sont déployés.
...
La lecture Cloud a ensuite abouti : les neuf exports publiés et leur comparaison figurent dans `annexe/n8n/published-20260923/`.
